...
void DescriptorSetRegistry::init_descriptor_pool(uint32_t const max_sets) {
  ...
  vk::utils::SetDebugObjectName(device_, main_pool_, "DescriptorSetRegistry::MainPool");
}
...
void DescriptorSetRegistry::create_main_set(
  ...
  vk::utils::SetDebugObjectName(device_, sets_[type].set,    "DescriptorSetRegistry::DescriptorSet::" + name);
  vk::utils::SetDebugObjectName(device_, sets_[type].layout, "DescriptorSetRegistry::DescriptorSetLayout::" + name);
};
